...
test: tmp/com/github/lindenb/fastorm/model/impl/EModelImpl.class
	java -cp ${CP}:tmp com.github.lindenb.fastorm.model.impl.EModelImpl \
		-o tmp \
...
tmp/com/github/lindenb/fastorm/model/impl/EModelImpl.class :  src/main/java/com/github/lindenb/fastorm/model/impl/EModelImpl.java
	mkdir -p tmp 
