...
public class EModelImpl
	...
	public  List<EPrimitiveDataType> getAllEPrimitives()
		{
		return Arrays.asList(EPrimitiveDataTypeImpl.getAllEPrimitives());
		}
	...
	extends Writer
		...
		private void _open(String fName,boolean ignoreIfExists)throws IOException
			...
			this.filename=new File(EModelImpl.this.getOutputDirectory(),fName);
		...
		public void openClass(String className)throws IOException
			{
			_open(
				EModelImpl.this.getName().toLowerCase()+
				"/src/main/java/"+
	...
	public static void main(String[] args) throws EModelException,IOException
		{
		int err=new EModelImpl().run(args);
		System.exit(err);
		}
